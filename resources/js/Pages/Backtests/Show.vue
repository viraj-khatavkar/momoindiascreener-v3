...
const form = useForm({
    ...
    transaction_charges_rate: props.backtest.transaction_charges_rate,
    sebi_charges_rate: props.backtest.sebi_charges_rate,
    gst_rate: props.backtest.gst_rate,
    stamp_charges_rate: props.backtest.stamp_charges_rate,
