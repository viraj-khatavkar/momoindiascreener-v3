...
class CreateDefaultScreenAction
{
    public function execute(string $name, User $user): Screen
    {
        return $user->screens()->create([
            'name' => $name,
            ...
            'columns' => [
                ScreenResultColumnEnum::SERIES,
                ScreenResultColumnEnum::MARKETCAP,
                ScreenResultColumnEnum::ABSOLUTE_RETURN_ONE_YEAR,
                ScreenResultColumnEnum::SHARPE_RETURN_ONE_YEAR,
                ScreenResultColumnEnum::BETA,
                ScreenResultColumnEnum::VOLATILITY_ONE_YEAR,
                ScreenResultColumnEnum::MA_200,
                ScreenResultColumnEnum::CLOSE_ADJUSTED,
            ],
        ]);
    }
}
