...
class UpdateScreenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'apply_filters_on' => ['required', Rule::enum(ApplyFiltersOnOptionEnum::class)],
            'apply_historical_date' => ['required', 'boolean'],
            'historical_date' => ['required_if:apply_historical_date,true', 'date', 'after_or_equal:2010-01-04'],
