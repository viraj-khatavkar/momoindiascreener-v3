    ...
    public function run(): void
    {
        ...
        if (! $user) {
            $user = User::factory()->create([
                'name' => 'System',
                'email' => 'system@momoindiascreener.in',
                'is_paid' => true,
                'is_admin' => true,
            ]);
        }
        ...
        $defaults = [
            ...
            'factor_two_sort_by' => ScreenSortByOptionEnum::volatility_one_year->value,
            'factor_two_sort_direction' => 'asc',
            'apply_factor_three' => false,
            'factor_three_sort_by' => ScreenSortByOptionEnum::beta->value,
            'factor_three_sort_direction' => 'asc',
            'apply_filters_on' => ApplyFiltersOnOptionEnum::ALL->value,
            'apply_historical_date' => false,
            'historical_date' => '2010-01-04',
            ...
            'custom_filter_one_value_two' => CustomFilterValueOptionEnum::ma_200->value,
            ...
            'custom_filter_two_value_two' => CustomFilterValueOptionEnum::ma_200->value,
            ...
            'custom_filter_three_value_two' => CustomFilterValueOptionEnum::ma_200->value,
            ...
            'custom_filter_four_value_two' => CustomFilterValueOptionEnum::ma_200->value,
            ...
            'custom_filter_five_value_two' => CustomFilterValueOptionEnum::ma_200->value,
        ];

        Screen::create(array_merge($defaults, [
            'name' => 'Sharpe Momentum - Nifty 500',
            'index' => NseIndexEnum::NIFTY_500->value,
            'sort_by' => ScreenSortByOptionEnum::sharpe_return_one_year->value,
            'columns' => [
                ScreenResultColumnEnum::SERIES->value,
                ScreenResultColumnEnum::ABSOLUTE_RETURN_ONE_YEAR->value,
                ScreenResultColumnEnum::SHARPE_RETURN_ONE_YEAR->value,
                ScreenResultColumnEnum::BETA->value,
                ScreenResultColumnEnum::VOLATILITY_ONE_YEAR->value,
                ScreenResultColumnEnum::MA_200->value,
                ScreenResultColumnEnum::CLOSE_ADJUSTED->value,
            ],
        ]));

        Screen::create(array_merge($defaults, [
            'name' => 'Absolute Momentum - All Stocks',
            'index' => NseIndexEnum::NIFTY_ALLCAP->value,
            'sort_by' => ScreenSortByOptionEnum::absolute_return_one_year->value,
            'columns' => [
                ScreenResultColumnEnum::SERIES->value,
                ScreenResultColumnEnum::ABSOLUTE_RETURN_ONE_YEAR->value,
                ScreenResultColumnEnum::ABSOLUTE_RETURN_SIX_MONTHS->value,
                ScreenResultColumnEnum::ABSOLUTE_RETURN_THREE_MONTHS->value,
                ScreenResultColumnEnum::BETA->value,
                ScreenResultColumnEnum::MA_200->value,
                ScreenResultColumnEnum::CLOSE_ADJUSTED->value,
            ],
        ...
        Screen::create(array_merge($defaults, [
            'name' => 'Low Volatility - Nifty 200',
            'index' => NseIndexEnum::NIFTY_200->value,
            'sort_by' => ScreenSortByOptionEnum::volatility_one_year->value,
            'sort_direction' => 'asc',
            'columns' => [
                ScreenResultColumnEnum::SERIES->value,
                ScreenResultColumnEnum::VOLATILITY_ONE_YEAR->value,
